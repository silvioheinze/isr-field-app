...
def _ensure_closed_ring_xy(ring_coords):
    """Return closed ring as list of (x, y) float tuples; GeoJSON exterior rings need >= 4 positions."""
...
def _polygon_from_geojson_polygon_coords(poly_coords):
    """Build GEOS Polygon from GeoJSON Polygon coordinates (exterior + optional holes)."""
...
def multipolygon_from_geojson_dict(geometry_data):
    """Parse GeoJSON Polygon or MultiPolygon into a GEOS MultiPolygon (SRID 4326)."""
